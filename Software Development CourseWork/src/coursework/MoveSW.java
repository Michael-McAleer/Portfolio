...
//Start of class MoveSW which implements Movement and Observable this is used for both the command pattern and observer pattern
public class MoveSW implements Movement, Observable {
	...
	//Constructor for MoveSW has one parameter Character ch sets ch to equal ch
	public MoveSW(Character ch){
		this.ch = ch;
	}
	//End of constructor
