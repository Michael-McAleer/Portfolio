...
//Start of class MoveE which implements Movement and Observable this is used for both the command pattern and observer pattern
public class MoveE implements Movement, Observable{
	...
	//Constructor for MoveE has one parameter Character ch sets ch to equal ch
	public MoveE(Character ch){
		this.ch = ch;
	}
	//End of constructor
