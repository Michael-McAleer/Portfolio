...
//Start of class MoveNW which implements Movement and Observable this is used for both the command pattern and observer pattern
public class MoveNW implements Movement, Observable{
	...
	//Constructor for MoveNW has one parameter Character ch sets ch to equal ch
	public MoveNW(Character ch){
		this.ch = ch;
	}
	//End of constructor
