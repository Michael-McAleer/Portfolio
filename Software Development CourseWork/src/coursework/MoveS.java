...
//Start of class MoveS which implements Movement and Observable this is used for both the command pattern and observer pattern
public class MoveS implements Movement, Observable{
	...
	//Constructor for MoveS has one parameter Character ch sets ch to equal ch
	public MoveS(Character ch){
		this.ch = ch;
	}
	//End of constructor
