...
//Start of class MoveN which implements Movement and Observable this is used for both the command pattern and observer pattern
public class MoveNE implements Movement, Observable{
	...
	//Constructor for MoveNE has one parameter Character ch sets ch to equal ch
	public MoveNE(Character ch){
		this.ch = ch;
	}
	//End of constructor
